  ...
  const handleDemoClick = () => {
    ...
    AuthService.postLogin(demoAccount)
      .then(res => {
        ...
        console.log(demoAccount.user_name)
        LoginPage.handleLoginSuccess(demoAccount.user_name)
      })
      .catch(res => {
    ...
    <div id='landing-page'>
      ...
      <section className='lp__section lp__last-section'>
        <header className='lp__header'>
            ...
            <button className='lp__button' onClick={handleDemoClick} >Demo Account</button>
        </header>
      </section>
    </div>
  )
